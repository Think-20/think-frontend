...
export class EmployeeFormComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.employeeForm = this.formBuilder.group({
      ...
      payment: this.formBuilder.control({ value: "0.00", disabled: !this.isAdmin }, [Validators.required]),
      department: this.formBuilder.control({ value: "", disabled: !this.isAdmin }, [Validators.required]),
      position: this.formBuilder.control({ value: "", disabled: !this.isAdmin }, [Validators.required]),
  ...
  loadEmployee() {
    ...
    this.employeeService.employee(employeeId).subscribe((employee) => {
      ...
      let payment = this.employee.payment != null ? this.employee.payment : 0.0;
